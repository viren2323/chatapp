...
import 'package:batchit/pages/profile_page.dart';
import 'package:batchit/pages/search_page.dart';
import 'package:batchit/service/auth_service.dart';
import 'package:batchit/service/database_service.dart';
import 'package:batchit/widgets/group_tile.dart';
import 'package:batchit/widgets/widgets.dart';
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          ...
                          return GroupTile(
                              ...
                              userName: getName(snapshot.data['fullName'][index]),
      ...
      padding: const EdgeInsets.symmetric(horizontal: 25),
       child: Column(
         ...
         children: [
           ...
           const Text(
             "You've not joined any groups,tap on the add icon ton create a group or also search from top search button.",
